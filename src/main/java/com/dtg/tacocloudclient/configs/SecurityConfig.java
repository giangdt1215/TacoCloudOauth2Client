package com.dtg.tacocloudclient.configs;

import com.dtg.tacocloudclient.services.IngredientService;
import com.dtg.tacocloudclient.services.RestIngredientService;
...
public class SecurityConfig {
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests(
                ...
                oauth2Login -> oauth2Login.loginPage("/oauth2/authorization/taco-giangdt"))
    ...
    public IngredientService ingredientService(OAuth2AuthorizedClientService clientService) {
        ...
        if(authentication.getClass().isAssignableFrom(OAuth2AuthenticationToken.class)) {
            ...
            if(clientRegistrationId.equals("taco-giangdt")) {
